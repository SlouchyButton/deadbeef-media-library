...
public:
    ...
    void initialize(Gtk::IconView* treeview, Addressbox* addressbox, MediaLibrary* medialibrary);
...
private:
    ...
    void findChildren(std::filesystem::path path);
